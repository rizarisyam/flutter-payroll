...
class PermissioinDetailPage extends StatefulWidget {
  const PermissioinDetailPage({Key? key}) : super(key: key);

  @override
  State<PermissioinDetailPage> createState() => _PermissioinDetailPageState();
}

class _PermissioinDetailPageState extends State<PermissioinDetailPage> {
  @override
